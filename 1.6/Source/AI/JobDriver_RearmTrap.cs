...
namespace VFESecurity
{
    public class JobDriver_RearmTrap : JobDriver
    {
        ...
        public override IEnumerable<Toil> MakeNewToils()
        {
            ...
            this.FailOnThingMissingDesignation(TrapInd, DefsOf.VFES_RearmTrap);
        ...
        private Toil RearmToil()
        {
            ...
            rearm.tickAction = () =>
            {
                ...
                else
                {
                    ...
                    // Remove designator
                    var rearmDes = trap.Map.designationManager.DesignationOn(trap, DefsOf.VFES_RearmTrap);
                    if (rearmDes != null)
                        rearmDes.Delete();

                    // Finalise
                    actor.records.Increment(DefsOf.VFES_TrapsRearmed);
